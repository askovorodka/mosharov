<?php /* Smarty version 2.6.11, created on 2012-02-06 13:26:40
         compiled from /home/alex/data/www/shop-toy.mosharov.com/conf/../templates/breadcrumbs.html */ ?>
<div class="nav"><?php if ($this->_tpl_vars['current_url'] != $this->_tpl_vars['default_url']): ?>
...
?>
			...
			<?php else: ?>
				<?php if (! ($this->_foreach['nav_loop']['iteration'] <= 1)): ?> &mdash; <?php endif; ?><a class="menu" href="<?php echo $this->_tpl_vars['nav']['url']; ?>
