<?php /* Smarty version 2.6.11, created on 2014-08-31 14:50:33
         compiled from /home/simpleuser/data/www/vlasovtoys.ru/modules/shop/admin/templates/shop.a_orders.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', '/home/simpleuser/data/www/vlasovtoys.ru/modules/shop/admin/templates/shop.a_orders.html', 41, false),array('modifier', 'string_format', '/home/simpleuser/data/www/vlasovtoys.ru/modules/shop/admin/templates/shop.a_orders.html', 47, false),)), $this); ?>
<?php echo '
...
"><strong><?php echo $this->_tpl_vars['entry']['user_name']; ?>
			...
			<td class=<?php echo $this->_tpl_vars['td']; ?>
_middle align="right">
				<?php echo ((is_array($_tmp=$this->_tpl_vars['entry']['total_price'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
