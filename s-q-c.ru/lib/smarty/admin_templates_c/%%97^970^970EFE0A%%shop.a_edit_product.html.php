<?php /* Smarty version 2.6.11, created on 2016-02-18 16:48:18
         compiled from /home/a0031953/domains/a0031953.xsph.ru/public_html//modules/shop/admin/templates/shop.a_edit_product.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', '/home/a0031953/domains/a0031953.xsph.ru/public_html//modules/shop/admin/templates/shop.a_edit_product.html', 199, false),array('function', 'math', '/home/a0031953/domains/a0031953.xsph.ru/public_html//modules/shop/admin/templates/shop.a_edit_product.html', 403, false),)), $this); ?>
<?php echo '
...
]: 						<select name="property_color" style="width:100px;"><option selected>выберите цвет<?php $_from = $this->_tpl_vars['colors']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['color']):
?><option value="<?php echo $this->_tpl_vars['color']['color']; ?>
" style="background-color: <?php echo $this->_tpl_vars['color']['color']; ?>
;"><?php echo $this->_tpl_vars['color']['color']; ?>
