<?php /* Smarty version 2.6.11, created on 2015-12-14 00:38:37
         compiled from /var/www/sqc//modules/shop/admin/templates/shop.a_edit_product.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', '/var/www/sqc//modules/shop/admin/templates/shop.a_edit_product.html', 198, false),array('function', 'math', '/var/www/sqc//modules/shop/admin/templates/shop.a_edit_product.html', 326, false),)), $this); ?>
<?php echo '
...
<tr>
  <td class=td1_left style="border-bottom: none;">Скидка:</td>
  <td class=td1_right style="border-bottom: none;">
  <input type="checkbox" name="edit_sale" value="1" <?php if ($this->_tpl_vars['product']['sale'] == '1'): ?>checked<?php endif; ?> />
  </td>
</tr>
...
?>
			<input
					<?php $_from = $this->_tpl_vars['product_properties']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]; ?>
			...
			<?php if ($this->_tpl_vars['entry']['0'] == @PROPERTY_COLOR_ID): ?>
				<div style="width:10px; height:10px; background-color: <?php echo $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]; ?>
; float:left; clear:both;">&nbsp;</div>
			<?php endif; ?>
