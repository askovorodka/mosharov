<?php /* Smarty version 2.6.11, created on 2016-03-31 20:06:46
         compiled from /home/a0031953/domains/s-q-c.ru/public_html//modules/shop/admin/templates/shop.a_edit_product.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', '/home/a0031953/domains/s-q-c.ru/public_html//modules/shop/admin/templates/shop.a_edit_product.html', 199, false),array('function', 'math', '/home/a0031953/domains/s-q-c.ru/public_html//modules/shop/admin/templates/shop.a_edit_product.html', 418, false),)), $this); ?>
<?php echo '
...
?>
			<input
					<?php $_from = $this->_tpl_vars['product_properties_old']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
 if ($this->_tpl_vars['item']['property_id'] == $this->_tpl_vars['entry']['0'] && $this->_tpl_vars['item']['value'] == $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]): ?>checked<?php endif;  endforeach; endif; unset($_from); ?>
					type="checkbox"
					name="edit_properties[<?php echo $this->_tpl_vars['entry']['0']; ?>
|<?php echo $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]; ?>
]"
					id="pt_<?php echo $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]; ?>
" value="<?php echo $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]; ?>
" />&nbsp;
			<label for="pt_<?php echo $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]; ?>
"><?php echo $this->_tpl_vars['entry']['3'][$this->_sections['element']['index']]; ?>
</label>
...
]: 						<select name="property_color" style="width:100px;"><option selected value="">выберите цвет<?php $_from = $this->_tpl_vars['colors']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['color']):
?><option value="<?php echo $this->_tpl_vars['color']['color']; ?>
" style="background-color: <?php echo $this->_tpl_vars['color']['color']; ?>
;"><?php if (! empty ( $this->_tpl_vars['color']['name'] )):  echo $this->_tpl_vars['color']['name'];  else:  echo $this->_tpl_vars['color']['color'];  endif; ?></option> <?php endforeach; endif; unset($_from); ?></select>
						<button type="submit">Добавить цвет</button>
						&nbsp;<a href="?mod=shop&action=delete_size&id=<?php echo $this->_tpl_vars['property']['id']; ?>
" onclick="return confirm('Удалить размер и все его цвета ?');">удалить размер</a>
					</form>
				</td>
			</tr>
			<?php endforeach; endif; unset($_from); ?>
