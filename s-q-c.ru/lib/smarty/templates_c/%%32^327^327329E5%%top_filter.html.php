<?php /* Smarty version 2.6.11, created on 2016-02-04 23:51:52
         compiled from /var/www/alex/data/www/scl.mosharov.com/conf/../modules/shop/front/templates/top_filter.html */ ?>
<div class="filters">
    <form id="filter">
...
" data-type="brand"><?php echo $this->_tpl_vars['item']; ?>
</div>
    ...
    foreach ($_from as $this->_tpl_vars['item']):
?>
                <div class="size" data-value="<?php echo $this->_tpl_vars['item']['value']; ?>
" data-type="size"><?php echo $this->_tpl_vars['item']['value']; ?>
</div>
                <?php endforeach; endif; unset($_from); ?>
        </div>
        <?php endif; ?>
    ...
    foreach ($_from as $this->_tpl_vars['item']):
?>
                    <div class="color" style="background:<?php echo $this->_tpl_vars['item']['value']; ?>
;" data-value="<?php echo $this->_tpl_vars['item']['value']; ?>
" data-type="color"></div>
                <?php endforeach; endif; unset($_from); ?>
        </div>
        <?php endif; ?>
