...
$(document).ready( function(){
	...
	//динамические строки
	get_pop_string($("input[name='search_product']"), "например: Cordiant polar SL PW-404");
	get_pop_string($("input[name='name']", $("form#form_order")), "например Иванов Иван");
	get_pop_string($("input[name='phone']", $("form#form_order")), "например 89031112233");
	get_pop_string($("input[name='email']", $("form#form_order")), "например ivanov@mail.ru");
	get_pop_string($("input[name='name']", $("form#fast_order_form")), "ваше фио", 0, 23);
	get_pop_string($("input[name='phone']", $("form#fast_order_form")), "ваш телефон", 0, 23);
	get_pop_string($("textarea[name='comment']", $("form#fast_order_form")), "Ваши пожелания. Например: доставка по адр. Москва, 3-я ул. Строителей, д.25, кв.12", 0, 23);
