...
$js[]=BASE_URL."/javascript/bootstrap/jquery.min.js";
...
//рекомендуем
$shop = new Shop($db);
$smarty->assign('top_products', $shop->getTopProducts(4));
...
if ($page_found) header("HTTP/1.0 200 OK");
  ...
  require_once (ROOT.'/modules/site_map/front/site_map.f_main.php');
