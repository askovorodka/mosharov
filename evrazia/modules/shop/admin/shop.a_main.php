...
$navigation[]=array("url" => BASE_URL . "/admin/?mod=shop","title" => 'Арендаторы');
...
SWITCH (TRUE) {
	...
	CASE ($action=='edit_cat' && isset($_GET['id'])):
		...
		$navigation[]=array("url" => BASE_URL."/admin/?mod=shop&action=catalogue","title" => 'Типы аренды');
		$navigation[]=array("url" => BASE_URL."/admin/?mod=shop&action=edit_cat","title" => 'Редактировать тип аренды');
...
/****************************************************************/
	...
	CASE ($action=='catalogue'):
		...
		$navigation[]=array("url" => BASE_URL."/admin/?mod=shop","title" => 'Типы аренды');
