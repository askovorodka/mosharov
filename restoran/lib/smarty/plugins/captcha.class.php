<?php
/*
	This file is taken from WeeWork 
	Original file: captcha.class.php 27 2006-08-23 10:20:27Z 
	It has slight modifications to cover the needs of generating the code before making the captcha
...
//        $this->GenStr(); 
    ...
    function PutLetters()
    {
        ...
        for($i=0 ; $i < $this->strLength ; $i++)
        {
            ...
            imagettftext($this->img, rand(14,20), $rotangle, $place, 30, $this->colorTxt[$i%2], $this->font, substr($this->strCheck, $i, 1) );
        }
    }
