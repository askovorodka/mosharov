...
cccp_vars = update_soup.items.cccp
...
DISK_PRICE_KOEF = float(cccp_vars['disk_koef'])
TIRE_PRICE_KOEF = float(cccp_vars['tire_koef'])

DISK_ROUND_KOEF = int(cccp_vars['disk_round_koef'])
TIRE_ROUND_KOEF = int(cccp_vars['tire_round_koef'])

CCCP_ENABLE = int(cccp_vars['enable'])
...
cmd = "/usr/local/bin/php /home/schmitz/data/www/cccp-shina.ru/images_downloader.php"
#os.system(cmd)
