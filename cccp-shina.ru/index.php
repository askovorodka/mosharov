...
{
	header("Location: http://cccp-shina.ru" . $_SERVER['REQUEST_URI']);
	die();
}
...
$css[] = BASE_URL."/templates/style_10_04_12.css";
...
if ($page_found) header("HTTP/1.0 200 OK");
  ...
  $smarty->assign("page_title","Ошибка 404. Страница не найдена.");
