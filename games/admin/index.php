...
$navigation[]=array("url" => BASE_URL."/admin/","title" => 'Главная');

/* --ПРОВЕРЯЕМ БРАУЗЕР КЛИЕНТА И ГРУЗИМ НУЖНЫЙ РЕДАКТОР --*/
...
/* --------- ГЕНЕРИРУЕМ ГЛАВНОЕ МЕНЮ АДМИНКИ -------------*/
$main_menu = '';
for ($m=0;$m<count($modules_list);$m++) {
...
/*--------- ПЕРЕДАЁМ СМАРТИ РАЗЛИЧНЫЕ ПЕРЕМЕННЫЕ ---------*/
