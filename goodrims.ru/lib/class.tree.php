...
class CDBTree {
	...
	function insert($ID, $data) {
		...
		/*
		 * update test set 
		 * param_left = if (param_left > $param_right, param_left+2, param_left),
		 * param_right = if (param_right >= $param_right, param_right+2, param_right)
		 * where param_right >= $param_right 
		 * */
