...
$news=$db->get_all("SELECT * FROM fw_news WHERE status='1' and cat_id=1 ORDER BY publish_date DESC limit 4");
$smarty->assign("news_list",$news);

$content=$db->get_all("SELECT * FROM fw_news WHERE status='1' and cat_id=2 ORDER BY publish_date DESC limit 4");
$smarty->assign("content_list",$content);
