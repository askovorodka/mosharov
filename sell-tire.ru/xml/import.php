...
system("/usr/local/bin/wget --user=demon --password=gthtgenmt -c --content-disposition -P {$path}xml/ http://itire.ru/xml/selltire.xml");

print "Start export: ".date("d-m-Y H:i:s")."\n";
print "Upload exported xml: http://itire.ru/xml/selltire.xml\n";
...
$xml = simplexml_load_file($path.'xml/selltire.xml');
$rims = $xml->rims->rim;
