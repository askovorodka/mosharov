...
selltire_vars = update_soup.items.selltire
...
DISK_PRICE_KOEF = float(selltire_vars['disk_koef'])
TIRE_PRICE_KOEF = float(selltire_vars['tire_koef'])

DISK_ROUND_KOEF = int(selltire_vars['disk_round_koef'])
TIRE_ROUND_KOEF = int(selltire_vars['tire_round_koef'])

SELLTIRE_ENABLE = int(selltire_vars['enable'])

if SELLTIRE_ENABLE != 1:
