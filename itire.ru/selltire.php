...
$CCCP_EXPORT = get_koef('SELLTIRE_EXPORT');
...
$disk_koef = get_koef('SELLTIRE_DISK_KOEF');
$tire_koef = get_koef('SELLTIRE_TIRE_KOEF');
$tire_round_koef = get_koef('SELLTIRE_TIRE_ROUND_KOEF'); 
$disk_round_koef = get_koef('SELLTIRE_DISK_ROUND_KOEF');


while ($item = mysql_fetch_assoc($res))
{

	if ($item['type'] == 'disk' && $suppliers['selltire'][$item['dealer']] == 1)
	{
	...
	if ($item['type'] == 'tire' && $suppliers['selltire'][$item['dealer']] == 1)
	{
